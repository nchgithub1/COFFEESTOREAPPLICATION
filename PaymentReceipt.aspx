<%@ Page Title="" Language="C#" MasterPageFile="~/MSite.Master" AutoEventWireup="true" CodeBehind="PaymentReceipt.aspx.cs" Inherits="CoffeeStore1.PaymentReceipt" %>
                            ...
                            <td>
                                <asp:Panel ID="pnlShippingPaymentDelivery" runat="server">
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <p style="text-align: center;"><div class="read_bt"><a runat="server" href="~/">Shopping</a></div></p>
                                                <br />
                                                <hr />
                                            </td>
                                        </tr>
