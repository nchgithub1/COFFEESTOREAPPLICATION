<%@ Page Title="" Language="C#" MasterPageFile="~/MSite.Master" AutoEventWireup="true" CodeBehind="OrderSummary.aspx.cs" Inherits="CoffeeStore1.OrderSummary" %>
                            ...
                            <td>
                                <asp:Panel ID="pnlShippingPaymentDelivery" runat="server">
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtShippingAddress" runat="server" ReadOnly="true" TextMode="MultiLine" Width="250px" Height="105px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtPaymentInformation" runat="server" ReadOnly="true" Width="250px" TextMode="MultiLine" Height="110px"></asp:TextBox>
                                            </td>
                                        </tr>
